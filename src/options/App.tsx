    ...
    <div className="container mx-auto">
      <nav className="flex flex-row justify-between items-center mt-5 px-2">
        <div className="flex flex-row items-center gap-2">
          ...
          <span className="font-semibold">ChatGPTSmartCleaner(v{getExtensionVersion()})</span>
        </div>
        <div className="flex flex-row gap-3">
          <a
            href="https://github.com/ishandutta2007/chatgpt-smartcleaner-extension/issues"
            target="_blank"
            rel="noreferrer"
          >
            Feedback
          ...
          <a
            href="https://github.com/ishandutta2007/chatgpt-smartcleaner-extension"
            target="_blank"
            rel="noreferrer"
          >
            Source code
      ...
      <main className="w-[600px] mx-auto mt-14">
        ...
        <div className="flex flex-row items-center gap-4">
          ...
          <Text b margin={0}>
            Auto delete conversations generated by chatGPT
          </Text>
        </div>
      </main>
    </div>
